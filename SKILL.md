...
AskUserQuestion:
  questions:
    - question: "请选择架构方案设计模式："
      ...
      options:
        - label: "快速模式（推荐）"
          description: "2-3分钟完成，启动1个探索代理，适合简单需求"
        - label: "深度模式"
          description: "5-15分钟完成，启动3个探索代理并行分析，适合复杂需求"
```
...
| 模式 | 耗时 | 探索代理数 | 适用场景 |
|------|------|-----------|----------|
| 快速模式 | 2-3分钟 | 1个 | 简单需求、熟悉的项目 |
| 深度模式 | 5-15分钟 | 3个并行 | 复杂需求、新项目 |
...
AskUserQuestion:
  questions:
    - question: "请选择编码方案设计模式："
      ...
      options:
        - label: "快速模式（推荐）"
          description: "2-3分钟完成，生成核心实现步骤"
        - label: "深度模式"
          description: "5-10分钟完成，生成详细伪代码和测试计划"
```
...
5. **编码方案文档**（如有） - Markdown 格式，保存在工作区根目录
